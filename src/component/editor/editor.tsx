...
import TEST_DOC from "/src/test-doc";
...
class Editor extends PureComponent<InferProps<typeof propTypes>, stateTypes> {
  ...
  constructor(
    ...
    this.handleTestDocumentSelectionChange = this.handleTestDocumentSelectionChange.bind(
      this
    );
  }
  ...
  loadTestDoc({ docName }: { docName: string }): void {
    const testDoc = TEST_DOC[docName] || (() => "");
        ...
        <EditorControls>
          <label>
            ...
            >
              ...
              {Object.keys(TEST_DOC).map((docKey) => (
