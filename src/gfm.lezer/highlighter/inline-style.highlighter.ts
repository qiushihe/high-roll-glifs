...
const LINE_DECORATOR: { [key: string]: Decoration } = {
...
const HEADING_LEVEL_DECORATOR: { [key: string]: Decoration[] } = {
  atx: [
    Decoration.line({
...
const inlineStyleDecorations = ViewPlugin.fromClass(
  InlineStyleDecorator
).decorations();
...
export default (): Extension[] => {
  return [inlineStyleTheme, inlineStyleDecorations];
};
